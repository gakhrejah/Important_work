...
BEGIN
	...
	insert into sk_product_data(product_id, last_modified, ean, upc) select UPPER(prd.product_id), last_mod_date, ean, upc from smsr12_cata_ci.dcs_product prd left join smsr12_cata_ci.sk_product skprd on prd.product_id=skprd.product_id;
