...
create table sk_ipckmat_view_port(
    	...
    	constraints 		sk_ipckmat_view_port_pk primary key (ipc_kmat_id,sequence_num,view_port));

create table sk_ipckmat_region(
	ipc_kmat_id	 	varchar2(40),
  	regions 		varchar2(40),
  	sequence_num 		number(*,0),
	constraints 		sk_ipckmat_region_pk primary key (ipc_kmat_id, sequence_num,regions));
