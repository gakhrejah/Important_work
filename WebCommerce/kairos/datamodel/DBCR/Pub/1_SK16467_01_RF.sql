...
create table  sk_prod_systems(
	...
	constraints 		sk_product_systems_pk primary key (product_id , sequence_num,asset_version));
...
create table sk_tech_spec(
	...
	constraint 		sk_tech_spec_pk primary key (id,asset_version));  
...
create table sk_prod_tech_spec(
	...
	tech_spec_id		varchar2(25),
  	sequence_num 		number(*,0),
  	constraint 		sk_prod_tech_spec_pk primary key (language_id,sequence_num,asset_version));